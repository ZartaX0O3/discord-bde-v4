...
module.exports = {
    ...
    aliases: ["sinfo","serveurinfo","serveurinfos","serverinfos"], //the command aliases for helpcmd [OPTIONAL]
    ...
    run: async (client, message) => {
        try {
            ...
            message.reply({embeds: [new Discord.MessageEmbed()
                    ...
                    .addField("❱ Text Channels", "💬 \`" + message.guild.channels.cache.filter(m => m.type === 'GUILD_TEXT').size + "\`", true)
                    .addField("❱ Voice Channels", "🔈 \`" + message.guild.channels.cache.filter(m => m.type === 'GUILD_VOICE').size + "\`", true)
                    ...
                    .addField("❱ OFFLINE", ":black_circle:\`" + message.guild.members.cache.filter(member => member.presence?.status !== "online").size + "\`", true)

                    .addField("❱ Total Boosts", `${emotes.emojis.boost}\`` + message.guild.premiumSubscriptionCount + "\`", true)
